...
export default function GetFineStatusBadge({ status }) {
    ...
    switch (status) {
        case PENDING:
            ...
            break;
        case SUCCESS:
            badge = 'text-white bg-gradient-to-r from-green-400 via-green-500 to-green-500 border-yellow-500';
            text = SUCCESS;
            break;
        case FAILED:
            badge = 'text-white bg-gradient-to-r from-red-400 via-red-500 to-red-500 border-yellow-500';
            text = FAILED;
            break;
        default:
            badge = '';
